...
function SelectBase({ className, defaultValue, disabled = false, hint, id, label, onValueChange, options, placeholder = 'Select an option', value }: SelectProps) {
...
function SelectField({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
