...
import { Paintbrush2, Palette } from 'lucide-react'
...
function CodeBlockBase({ className, defaultLanguage, defaultTone = 'color', showLanguageTabs = true, showToneToggle = true, snippets, ...props }: CodeBlockProps) {
  ...
  return (
    <div
      ...
      {...props}
    >
      {(showLanguageTabs && snippets.length > 1) || showToneToggle ? (
